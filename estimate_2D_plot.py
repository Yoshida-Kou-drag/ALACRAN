...
sys.path.append('./mini_alacran/estimate/script/')
...
if __name__ == "__main__":
    ...
    left_tilt,right_tilt,left_pitch,right_pitch = -41.45007751861285, 72.80548802509185, 1.1947572164075917, 2.3539450172845955
